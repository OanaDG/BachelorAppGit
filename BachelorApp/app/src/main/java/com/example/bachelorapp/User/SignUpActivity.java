...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void createAccount() {
        ...
        {
            Toast.makeText(SignUpActivity.this, "Please introduce an username without the character '.'", Toast.LENGTH_LONG).show();
        }
                ...
                if(!(snapshot.child(parentDbName).child(username).exists())){
                    ...
                    rootRef.child("Users").child(username).updateChildren(userdata).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            {
                                loading.dismiss();
                                Intent intent = new Intent(SignUpActivity.this, GenrePreferencesActivity.class);
